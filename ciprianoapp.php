...
//session_set_cookie_params(0, "cipriano_ui" );
session_start ();
...
/*
ob_start();
system('java -jar /home/bernardo/workspacejee/cipriano-proxy/bin/cipriano-proxy.jar', $retval);
$factory = trim(ob_get_contents());
ob_clean();
*/
CiprianoUISetup::initialize($appname);

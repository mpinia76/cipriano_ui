...
class CiprianoMetroLayout extends RastyLayout{
	...
	public function getContent(){
		...
		$xtpl = $this->getXTemplate( dirname(__DIR__) . "/layouts/CiprianoMetroLayout.htm" );
...
// 		$this->addStyle( "$webPath/metro/less/metro-bootstrap.less");
		...
		$this->addStyle( "$webPath/metro/css/cipriano_forms.css");
	...
	protected function initScripts(){
		...
		$this->addScript("$webPath/js/cipriano.js");
		$this->addScript("$webPath/js/cipriano_utils.js");
		$this->addScript("$webPath/js/cipriano_forms.js");

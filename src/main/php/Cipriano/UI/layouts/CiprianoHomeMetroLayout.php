...
class CiprianoHomeMetroLayout extends CiprianoMetroLayout{
	...
	public function getContent(){
		...
		$xtpl = $this->getXTemplate( dirname(__DIR__) . "/layouts/CiprianoHomeMetroLayout.htm" );
	...
	public function getType(){
		...
		return "CiprianoHomeMetroLayout";

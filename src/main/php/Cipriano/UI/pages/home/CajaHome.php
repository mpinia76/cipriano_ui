...
class CajaHome extends AdminHome{
	...
	public function __construct(){
		...
		if( CiprianoUIUtils::isCajaSelected() )
			$this->setCaja(  UIServiceFactory::getUICajaService()->get(  CiprianoUIUtils::getCaja()->getOid()) );
	...
	protected function parseXTemplate(XTemplate $xtpl){
		...
		if( CiprianoUIUtils::isCajaSelected() ){
			...
			//$xtpl->assign("caja_legend", CiprianoUIUtils::formatMessage( $this->localize("empleado_home.caja.legend"), array($caja->getNumero())) );
	...
	public function getTitle(){
			...
			$nombre ="";
		return CiprianoUIUtils::formatMessage( $this->localize("empleado_home.title"), array($nombre)) ;
	}

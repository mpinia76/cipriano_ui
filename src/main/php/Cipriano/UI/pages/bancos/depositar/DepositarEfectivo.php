<?php
namespace Cipriano\UI\pages\bancos\depositar;
...
class DepositarEfectivo extends CiprianoPage{
	...
	public function __construct(){
		...
		$this->banco = UIServiceFactory::getUIBancoService()->getCuentaJosefina();

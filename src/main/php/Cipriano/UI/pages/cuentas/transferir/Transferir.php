<?php
namespace Cipriano\UI\pages\cuentas\transferir;


use Cipriano\UI\components\filter\model\UICuentaCorrienteCriteria;

use Cipriano\UI\service\UICuentaCorrienteService;

use Cipriano\UI\components\filter\model\UIBancoCriteria;

use Cipriano\UI\components\filter\model\UICuentaSocioCriteria;

use Cipriano\UI\service\UISucursalService;

use Cipriano\UI\components\filter\model\UICuentaCriteria;

use Cipriano\UI\service\finder\CuentaFinder;
...
class Transferir extends CiprianoPage{
	...
	protected function parseLabels(XTemplate $xtpl){
		...
		$xtpl->assign("legend",  $this->localize( "cipriano.transferir.legend" ) );
	...
	public function getTitle(){
		return $this->localize("cipriano.transferir.title") ;
	}
	...
	public function getDestinos(){
		...
		$ciprianoCorrientes = UIServiceFactory::getUICuentaCorrienteService()->getList( new UICuentaCorrienteCriteria());
		...
		$destinos = array_merge($destinos, $ciprianoCorrientes);*/

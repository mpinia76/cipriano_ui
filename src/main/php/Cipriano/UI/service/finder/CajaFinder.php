<?php
namespace Cipriano\UI\service\finder;

use Cipriano\UI\utils\CiprianoUIUtils;

use Cipriano\UI\components\filter\model\UICajaCriteria;
...
class CajaFinder implements  IAutocompleteFinder {
	...
	function getEntityLabel( $entity ){
		...
		if( !empty( $entity)  ){
			...
			$params = array( $entity->getNumero(), $entity->getCajero(), CiprianoUIUtils::formatMontoToView($entity->getSaldo()) );
			return CiprianoUIUtils::formatMessage( $msg, $params);
		}

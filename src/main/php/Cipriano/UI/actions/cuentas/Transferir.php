<?php
namespace Cipriano\UI\actions\cuentas;
...
/**
 * se realiza una transferencia entre cipriano
 *
 * @author Bernardo
 * @since 25-06-2014
 */
class Transferir extends Action{
	...
	public function execute(){
		...
		$forward = new Forward();
		$fechaHora = CiprianoUIUtils::newDateTime( RastyUtils::getParamPOST("fechaHora").' '.date('H:i') );

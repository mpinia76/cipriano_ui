...
use Cipriano\UI\components\grid\formats\GridEstadoVentaFormat;

use Cipriano\UI\components\filter\model\UIVentaCriteria;
...
class VentaGridModel extends EntityGridModel{
	...
	public function getRowStyleClass($item){
		...
		return CiprianoUIUtils::getEstadoVentaCss($item->getEstado());

...
use Cipriano\UI\components\grid\formats\GridEstadoGastoFormat;
...
//		//TODO esto setearlo en el .rasty
	...
	public function getRowStyleClass($item){
		...
		//return CiprianoUIUtils::getEstadoGastoCss($item->getEstado());
	...
	public function getHeaderContent(){
		...
		return 'Total: '.CiprianoUIUtils::formatMontoToView($service->getTotales($filter->getCriteria()));
	}

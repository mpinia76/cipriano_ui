...
namespace Cipriano\UI\components\boxes\banco;
...
class BancoBox extends RastyComponent{
	...
	protected function parseXTemplate(XTemplate $xtpl){
		...
		if( !empty($banco )){
			...
			$xtpl->assign("saldo",  CiprianoUIUtils::formatMontoToView($banco->getSaldo()) );
			$xtpl->assign("saldoInicial",  CiprianoUIUtils::formatMontoToView($banco->getSaldoInicial()) );

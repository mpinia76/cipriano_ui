...
namespace Cipriano\UI\components\boxes\gasto;
...
class GastoBox extends RastyComponent{
	...
	protected function parseXTemplate(XTemplate $xtpl){
		...
		$xtpl->assign( "monto", CiprianoUIUtils::formatMontoToView( $this->getGasto()->getMonto() ) );
		$xtpl->assign( "observaciones", $this->getGasto()->getObservaciones() );
		$xtpl->assign( "fechaHora", CiprianoUIUtils::formatDateTimeToView($this->getGasto()->getFechaHora()) );
		$xtpl->assign( "fechaVencimiento", CiprianoUIUtils::formatDateTimeToView($this->getGasto()->getFechaVencimiento()) );

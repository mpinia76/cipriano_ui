...
namespace Cipriano\UI\components\boxes\pago;
...
class PagoBox extends RastyComponent{
	...
	protected function parseXTemplate(XTemplate $xtpl){
		...
		$xtpl->assign( "monto", CiprianoUIUtils::formatMontoToView( $this->getPago()->getMonto() ) );
		$xtpl->assign( "observaciones", $this->getPago()->getObservaciones() );
		$xtpl->assign( "fechaHora", CiprianoUIUtils::formatDateTimeToView($this->getPago()->getFechaHora()) );
